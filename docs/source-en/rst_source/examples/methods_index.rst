     ...
     <div style="flex: 1 1 30%; max-width: 300px; text-align: center;">
       ...
       <p style="margin-top: 8px; font-size: 14px; line-height: 1.4;">
         <a href="embodied/continual_libero.html" style="text-decoration: underline; color: blue;">
           <b>Sequential LoRA Fine-Tuning on LIBERO</b>
         </a><br>
         Train one task or sequentially update LoRA across a LIBERO task range
       </p>
     </div>
...
.. toctree::
   ...
   Sequential LoRA on LIBERO <embodied/continual_libero>
